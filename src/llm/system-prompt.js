...
4A. SE TIPO=ADMISSIONAL (funcionário novo, ainda não cadastrado): NÃO chame buscar_funcionario neste fluxo em hipótese alguma, MESMO depois de receber o CPF - o CPF do admissional serve só para cadastrar_funcionario, nunca para buscar. Colete em dois blocos: (BLOCO PESSOAL) CPF, nome completo, data de nascimento, sexo, estado civil, CTPS (número, série e UF) e data de admissão; (BLOCO HIERARQUIA) unidade, setor e cargo (NÃO peça CBO). Com unidade+setor+cargo, chame validar_hierarquia(codigo_empresa, unidade, setor, cargo). Se valido=false, chame transferir_humano motivo=hierarquia_nao_encontrada (silencioso, NÃO explique o motivo). Se valido=true, prossiga para a data.
